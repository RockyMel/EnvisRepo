			...
			while(true)
			{
				...
				try{
					if(obj.getJSONArray(i+"")!=null){
						id = obj.getJSONArray(i+"").getString(1);
						name = obj.getJSONArray(i+"").getString(2);
						longitude = Double.parseDouble(obj.getJSONArray(i+"").getString(3));
						latitude = Double.parseDouble(obj.getJSONArray(i+"").getString(4));
		...
		if(resultsRequestSOAP.toString()!=null)
		{
			...
			while(true)
			{
				...
				try{
					if(obj.getJSONArray(i+"")!=null){
						id = obj.getJSONArray(i+"").getString(1);
						type = obj.getJSONArray(i+"").getInt(2);
						name = obj.getJSONArray(i+"").getString(3);
						brand = obj.getJSONArray(i+"").getString(4);
						notes = obj.getJSONArray(i+"").getString(5);
		...
		if(resultsRequestSOAP.toString()!=null)
		{
			...
			while(true)
			{
				...
				try{
					if(obj.getJSONArray(i+"")!=null){
						id = obj.getJSONArray(i+"").getString(1);
						z = (float)obj.getJSONArray(i+"").getDouble(2);
						longitude = (float)obj.getJSONArray(i+"").getDouble(3);
						latitude = (float)obj.getJSONArray(i+"").getDouble(4);
						name = obj.getJSONArray(i+"").getString(5);
						notes = obj.getJSONArray(i+"").getString(6);
						xcoor = obj.getJSONArray(i+"").getString(7);
						ycoor = obj.getJSONArray(i+"").getString(8);
	...
	public static void SyncSetAndSensorAssociation(Context context){
		...
		if(resultsRequestSOAP.toString()!=null)
		{
			...
			while(true)
			{
				...
				try{
					if(obj.getJSONArray(i+"")!=null){
						sensorid = obj.getJSONArray(i+"").getString(1);
						setid = obj.getJSONArray(i+"").getString(2);
			...
			while(true)
			{
				...
				try{
					if(obj.getJSONArray(i+"")!=null){
						...
						mapid = obj.getJSONArray(i+"").getString(2);
						x = (float)obj.getJSONArray(i+"").getDouble(3);
						y = (float)obj.getJSONArray(i+"").getDouble(4);
						z = (float)obj.getJSONArray(i+"").getDouble(5);
